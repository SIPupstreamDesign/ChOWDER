...
/* window.load                                                                */
/******************************************************************************/
function initTimelineTemplate(options) {
    /*-----* view url *-----------------------------------------------------------*/
    ...
    $("#timeline").k2goTimeline({
            ...
            timeChange: function(pTimeInfo) {
                ...
                if (options.hasOwnProperty('timeChange')) {
                    options.timeChange(pTimeInfo);
                }
            },
            ...
            barMove: function(pTimeInfo) {
                if (options.hasOwnProperty('barMove')) {
                    options.barMove(pTimeInfo);
                }
                putEventInfo("bar  move");
            },
            barMoveEnd: function(pTimeInfo) {
                adjustRangeBar();
                if (options.hasOwnProperty('barMoveEnd')) {
                    options.barMove(pTimeInfo);
                }
...
export default {
    initTimelineTemplate: initTimelineTemplate,
    initTimelineTemplateEvents: initTimelineTemplateEvents,
}