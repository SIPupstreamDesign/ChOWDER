...
ChOWDER Desktop Capture のインストールと動作環境
-----------------------
### インストールスクリプトの実行
...
<img src="image/dc_cap09.png" alt="送信先グループ設定フォーム" width="600" />*送信先グループ設定フォーム*
